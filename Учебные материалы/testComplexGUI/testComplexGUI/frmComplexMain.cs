...
namespace testComplexGUI
{
    public partial class frmComplexMain : Form
    {
        ...
        private void ShowChildForm(byte mode, clsComplex val = null)
        {
            frmCreateChange frm = new frmCreateChange(mode, val);
            frm.ShowDialog(this);
            frm.Dispose();
            InitState();
        }
        ...
        private void btnChange_Click(object sender, EventArgs e) => ShowChildForm(1, mdlData.colComplex[lstComplex.SelectedIndex]);
        ...
        private void lstComplex_SelectedIndexChanged(object sender, EventArgs e) => InitState(false);
